...
if not "AllMessages" in st.session_state:
    st.session_state.AllMessages=[{"role": "system", "content": f"You are an assistant that helps people develop their curriculum vitae. You get their experience, and you produce a neat curriculum vitae. You don't talk about job possibilities."}]
