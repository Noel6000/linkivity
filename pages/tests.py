...
if stb.true_or_false(f"To print 'Hello world', you would write \"print(\"Hello World\")\"", True):
  correct += 1
  questions += 1
if not stb.true_or_false(f"To print 'Hello world', you would write \"print(\"Hello World\")\"", True):
  questions += 1
...
if stb.single_choice("How do you insert COMMENTS in Python code?", ["\#This is a comment", "//This is a comment", "/*This is a comment*/"], 0):
  correct += 1
  questions += 1
if not stb.single_choice("How do you insert COMMENTS in Python code?", ["\#This is a comment", "//This is a comment", "/*This is a comment*/"], 0):
  questions += 1
